...
pub fn enable_rls_sql(table: &str, schema: Option<&str>) -> String {
    ...
    format!("ALTER TABLE {}{} ENABLE ROW LEVEL SECURITY;", schema_prefix, table)
}
...
pub fn disable_rls_sql(table: &str, schema: Option<&str>) -> String {
    ...
    format!("ALTER TABLE {}{} DISABLE ROW LEVEL SECURITY;", schema_prefix, table)
}
...
pub fn force_rls_sql(table: &str, schema: Option<&str>, force: bool) -> String {
    ...
    format!("ALTER TABLE {}{} FORCE ROW LEVEL SECURITY {};", schema_prefix, table, force_str)
} 